	...
	<body>
		...
		<?php require_once("../resource/sections/branch_shortcuts.php"); ?>
			<div>
				...
				<div class="panel-heading"><svg class="glyph stroked clipboard with paper"><use xlink:href="#stroked-clipboard-with-paper"></use></svg>   TEAM CLIENT LIST</div>
						...
						<?php
							...
							$result = mysqli_query($mysqli, "SELECT 
														...
														FROM
														    `entity` AS E
														LEFT JOIN
															`entity` AS ET ON ET.`ID` = E.`AccountOwner`
														WHERE
														    E.`Mark` = 1 AND E.Type = 4
														        AND `ET`.TeamID = '$team'
														        AND E.`IsClient` = '1'");
