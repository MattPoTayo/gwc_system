	...
	<body>
		...
		<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">	
			<div class="form_class">
				<div class="form_title"><div class="panel-heading"><svg class="glyph stroked laptop computer and mobile"><use xlink:href="#stroked-laptop-computer-and-mobile"/></use></svg>EDIT BRAND</div></div>
					<div>
						<?php
							require_once("../resource/database/hive.php");
							$brand = mysqli_query($mysqli, "SELECT * FROM `brand` WHERE `ID` = '$id'");
							...
							if($_POST)
							{
								...
								{
									$sqlquery = "UPDATE `brand` SET `Name` = '$name' WHERE `ID` = '$id'";
									echo $sqlquery;
									$new = mysqli_query($mysqli, $sqlquery);
												      
									if($new) $_SESSION['success'] = "Edited brand succesfully saved";
					...
					<div class="form_content">
						<form class="form-horizontal" method=post action="<?php echo $_SERVER['PHP_SELF'];?>">
								...
								<div class="form-group">
									...
									<div class="col-sm-offset-0 col-sm-6">
									<a class="btn form_button" href="brand.php" role="button">Back</a>
								</div>
							</div>				
						</form>
						</div>
