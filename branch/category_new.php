...
<html>
	...
	<body>
		...
		<div class="form_class">
			<div class="form_title"><div class="panel-heading"><svg class="glyph stroked laptop computer and mobile"><use xlink:href="#stroked-laptop-computer-and-mobile"/></use></svg>NEW CATEGORY</div></div>
				<div>
					<?php
						if($_POST)
						{
							...
							{
								$sqlquery = "INSERT INTO `category`(`Name`, `Code`) 
											      VALUES ('$name', '$code')";
								echo $sqlquery;
							...
							<form class="form-horizontal" method=post action="<?php echo $_SERVER['PHP_SELF'];?>">
								<div class="form-group">
									<div class="col-sm-8">
										...
										<input name="name" type="text" class="form-control" placeholder="Category Name" value=<?php echo "'".$name."'"; ?> required>
									</div>
									<div class="col-sm-4">
										<label for="code">Category Code*</label>
										<input name="code" type="text" class="form-control" placeholder="Category Code" value=<?php echo "'".$code."'"; ?> disabled>
									</div>
								</div>
