		...
		<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
			<div>
				...
				<table class="table" style="width:100%;font-size:12px">
						...
						<tr><td style="width:20%">Purchase Code</td><td style="width:30%"><?php echo $row3[9]; ?></td></tr>
						...
						<tr>
							...
							<?php
								if($row3[8] == 1) echo "Available";
								else if($row3[8] == 2) echo "On Transaction";
								else if($row3[8] == 3) echo "Sold";
								else if($row3[8] == 4) echo "Borrowed";
								else if($row3[8] == 5) echo "Repairing";
								else if($row3[8] == 6) echo "Released";
							?>
							</td>
						</tr>
