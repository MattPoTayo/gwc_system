	...
	<body>
		...
		<?php require_once("../resource/sections/branch_shortcuts.php"); ?>
			<div>
				...
				<div class="panel-heading"><svg class="glyph stroked clipboard with paper"><use xlink:href="#stroked-clipboard-with-paper"></use></svg>   CATEGORY TYPES</div>
				<div class="table-wrapper">
						...
						<?php
							...
							echo '<th style="width:15%;text-align:center;" data-priority="1">Category ID</th>';
							echo '<th style="width:15%;text-align:center;" data-priority="2">Category Code</th>';
							echo '<th style="width:60%;text-align:center;" data-priority="5">Category Name</th>';
							...
							{	
								...
								//Actions
								echo '<td><a href="category_edit.php?type='.$row[0].'"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>&nbsp&nbsp|&nbsp&nbsp<a href="category_list.php?id='.$row[0].'&action=view"><i class="fa fa-file" aria-hidden="true"></i> Items Under Category</a></td>';
