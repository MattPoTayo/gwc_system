		...
		<?php require_once("../resource/sections/branch_shortcuts.php"); ?>
			<div>
				<div class="row" style="margin-left:1px;">
					<a href="#">
					<div class="panel-heading"><svg class="glyph stroked clipboard with paper"><use xlink:href="#stroked-clipboard-with-paper"></use></svg>   ACTIVITIES</div>
					<div class="messages">
						<?php
				...
				<div class="table-wrapper">
						...
						<?php
							...
							$sqlquery = "SELECT 
									...
									WHERE
									    A.`Mark` >= 1 AND A.`Creator` = '$creatorid'
									GROUP BY A.`ID`
									ORDER BY `ID` DESC";
							#echo $sqlquery;
