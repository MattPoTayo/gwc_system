	...
	<body>
		...
		<?php require_once("../resource/sections/branch_shortcuts.php"); ?>
			<div>
				...
				<div class="panel-heading"><svg class="glyph stroked clipboard with paper"><use xlink:href="#stroked-clipboard-with-paper"></use></svg>   CLIENT MANAGEMENT</div>
				<div class="table-wrapper">
						...
						<?php
							...
							$result = mysqli_query($mysqli, "SELECT 
									    E.`ID`, E.`Name`, E.`Address`, E.`Phone`, E.`Birthdate`, E.`Username`
									FROM
									    `entity` AS E
									LEFT JOIN `sales_head` AS SH ON SH.`Destination` = E.`ID`
									WHERE
									    E.`Mark` = 1 AND E.`IsClient` = '1' GROUP BY E.`ID`");
