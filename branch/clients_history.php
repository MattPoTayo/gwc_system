		...
		<?php require_once("../resource/sections/branch_shortcuts.php"); ?>
			<div>
				<div class="row" style="margin-left:1px;">
					<div class="panel-heading"> CLIENT HISTORY</div>
					<div class="messages">
						<?php
				...
				<div class="table-wrapper">
						...
						<?php
							...
							{	
								...
								//Actions
								echo '<td><a target="_blank" href="pdf-receipt.php?id='.$row[0].'&action=view"><i class="fa fa-file-o" aria-hidden="true"></i> View</a></td>';
