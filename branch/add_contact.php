...
<html>
	...
	<body>
		...
		<div class="form_class_full">
			<div class="form_title"><div class="panel-heading"><svg class="glyph stroked laptop computer and mobile"><use xlink:href="#stroked-laptop-computer-and-mobile"/></use></svg>NEW SUPPLIER CONTACT</div></div>
				<div>
					<?php
						if($_POST)
							{
