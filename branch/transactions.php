		...
		<?php require_once("../resource/sections/branch_shortcuts.php"); ?>
			<div>
				<div class="row" style="margin-left:1px;">
					<a href="#">
					<div class="panel-heading"><svg class="glyph stroked clipboard with paper"><use xlink:href="#stroked-clipboard-with-paper"></use></svg>   TRANASACTIONS</div>
					<div class="messages">
						<?php
				...
				<div class="table-wrapper">
						...
						<?php
							...
							{	
								...
								//Actions
								if($row[8] == 1) echo '<td><a href="pdf-receipt.php?id='.$row[0].'&action=view" target="_blank"><i class="fa fa-file-o" aria-hidden="true"></i> View</a>&nbsp|&nbsp<a href="transactions.php?reverse='.$row[0].'&action=reverse"><i class="fa fa-undo" aria-hidden="true"></i> Reverse</a></td>';
