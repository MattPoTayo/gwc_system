			...
			<div>
				...
				<table class="table" style="width:100%;font-size:12px">
					<?php
						...
						$result3 = mysqli_query($mysqli, "SELECT * FROM `supplier` WHERE `ID` = '$id'");
						$result3->data_seek(0);
					    	$row3 = $result3->fetch_row();
					?>
					<tr><td style="width:20%">Supplier ID</td><td style="width:30%"><?php echo $row3[0]; ?></td>
					<td style="width:20%">Name</td><td style="width:30%"><?php echo $row3[1]; ?></td></tr>
					<tr><td style="width:20%">Address</td><td style="width:30%"><?php echo $row3[2]; ?></td><td style="width:20%">Phone</td><td style="width:30%"><?php echo $row3[3]; ?></tr>
				...
				<div class="panel-heading"> Supplier Inventory List</div>
				<div class="table-wrapper">
						...
						<?php
							...
							echo '<th style="width:10%;text-align:center;" data-priority="4">Brand</th>';
							echo '<th style="width:10%;text-align:center;" data-priority="5">Category</th>';
							echo '<th style="width:15%;text-align:center;" data-priority="6">Description</th>';
							echo '<th style="width:7%;text-align:center;" data-priority="7">Purchase Code</th>';
							echo '<th style="width:10%;text-align:center;" data-priority="8">Weight</th>';
