		...
		<?php require_once("../resource/sections/branch_menu.php"); ?>
			...
			<?php require_once("../resource/sections/branch_shortcuts.php"); ?>
				<div class="form_class_full">
					<div class="form_title"><div class="panel-heading"><svg class="glyph stroked dashboard-dial">svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg>EDIT CLIENT</div></div>
					<div>
						<div>
							<?php
								require_once("../resource/database/hive.php");
								...
								{	
									if(isset($_POST['id']))
									{
										...
										{
											$sqlstring = "UPDATE `entity` SET `Name` = '$name', `Birthdate` = '$datemodified', `Phone` = '$phone', `Address` = '$address', `Username` = '$email', `Tin` = '$tin', `VatMode` = '$vatmode' WHERE `ID` = '$id'";
											$new = mysqli_query($mysqli, $sqlstring);
											#echo $sqlstring;
											if($new)
												$_SESSION['success'] = '<div class="alert bg-success" role="alert"><svg class="glyph stroked checkmark"><use xlink:href="#stroked-checkmark"></use></svg> Succesfully updated client details<a href="clients.php" class="pull-right"><span class="glyphicon glyphicon-remove"></span></a></div>';
											else 
												$_SESSION['fail'] = '<div class="alert bg-danger" role="alert"><svg class="glyph stroked cancel"><use xlink:href="#stroked-cancel"></use></svg> Error in saving client details. Call Administrator for support<a href="clients.php" class="pull-right"><span class="glyphicon glyphicon-remove"></span></a></div>';
						...
						<div class="form_content">
							<form class="form-horizontal" method=post action="<?php echo $_SERVER['PHP_SELF'];?>">
								...
								<div class="form-group">
									...
									<div class="col-sm-offset-0 col-sm-6">
									<a class="btn form_button" href="clients.php" role="button">Back</a>
								</div>
								</div>				
							</form>
						</div>
